...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('/admin')}}" class="nav-link">HABBI</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('index3.html')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Habbi Web</span>
    </a>
    ...
    <!-- Content alert -->
  @if ((($message =Session::get('success'))&&($icono =Session::get('icono'))))
                <script>
                  Swal.fire({
                    icon: "{{$icono}}",
                    title: 'Exito',
